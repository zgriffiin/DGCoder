...
import Migration0020 from "./Migrations/020_ProjectionSnapshotWindowIndexes.ts";
import Migration0021 from "./Migrations/021_ProjectionProjectsRepositoryIdentity.ts";
...
export const migrationEntries = [
  ...
  [20, "ProjectionSnapshotWindowIndexes", Migration0020],
  [21, "ProjectionProjectsRepositoryIdentity", Migration0021],
] as const;
