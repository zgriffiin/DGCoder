...
export const QualityGateSettings = Schema.Struct({
  ...
  requireIntent: Schema.Boolean.pipe(Schema.withDecodingDefault(() => true)),
  requireFunctionalValidation: Schema.Boolean.pipe(Schema.withDecodingDefault(() => true)),
...
const QualityGateSettingsPatch = Schema.Struct({
  ...
  requireFunctionalValidation: Schema.optionalKey(Schema.Boolean),
